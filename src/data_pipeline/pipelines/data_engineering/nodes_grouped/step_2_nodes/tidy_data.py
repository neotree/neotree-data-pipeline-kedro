...
def tidy_data(deduplicate_admissions_output,deduplicate_data_output,deduplicate_discharges_output):
    try:
        #Test If Previous Node Has Completed Successfully
        if (deduplicate_admissions_output is not None and  deduplicate_data_output is not None 
        and deduplicate_discharges_output is not None):
            tidy_tables()
