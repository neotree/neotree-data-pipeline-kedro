...
def create_convinience_views_query():
  return ''' DROP TABLE IF EXISTS derived.summary_joined_admissions_discharges;
            ...
            derived.joined_admissions_discharges."AdmissionWeight.value" AS "AdmissionWeight", 
            ...
            derived.joined_admissions_discharges."AgeCategory" AS "AgeCategory",
            ...
            derived.joined_admissions_discharges."BloodSugarmmol.value" AS "BloodSugar_mmo_L",
            ...
            derived.joined_admissions_discharges."BirthWeight.value"::integer < 1000 then 1 End AS "Less28wks/1kgCount",
            ...
            CASE WHEN derived.joined_admissions_discharges."BirthWeight.value" < 2500 THEN 1 end AS "PrematureCount",
