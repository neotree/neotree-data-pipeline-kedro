import pandas as pd
import json
from conf.common.sql_functions import create_union_views, get_table_columns, inject_sql
import logging
...
def union_views():
    try:
        ...
        adm_where = f'''where "DateTimeAdmission.value" >'2021-02-28' '''
        disc_where = f'''where "DateTimeDischarge.value" >'2021-02-28' or "DateTimeDeath.value">'2021-02-28' '''
