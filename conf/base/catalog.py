...
old_scripts = ['admissions','discharges','maternals','maternals_dev','vital_signs','neolabs','baselines','maternity_completeness','country','name']
                  ...
                  for script in ids.keys():            
                     if script!='name' and script!='country':
                        ...
                        if script not in processed_script_names: 
                           ...
                           script_case = f''', CASE WHEN sriptid='{script_id}' then {hospital}  '''
